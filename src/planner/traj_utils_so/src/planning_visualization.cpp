...
namespace ego_planner
{
  PlanningVisualization::PlanningVisualization(std::shared_ptr<rclcpp::Node>& nh)
  {
    ...
    global_list_pub = nh->create_publisher<visualization_msgs::msg::Marker>("global_list", 2);
    // init_list_pub = nh.advertise<visualization_msgs::msg::Marker>("init_list", 2);
    init_list_pub = nh->create_publisher<visualization_msgs::msg::Marker>("init_list", 2);
    // optimal_list_pub = nh.advertise<visualization_msgs::msg::Marker>("optimal_list", 2);
    optimal_list_pub = nh->create_publisher<visualization_msgs::msg::Marker>("optimal_list", 2);
                                                ...
                                                Eigen::Vector4d color, int id, bool show_sphere /* = true */ )
  {
    ...
    sphere.header.stamp = line_strip.header.stamp = _clock.now();
  ...
  void PlanningVisualization::displayGoalPoint(Eigen::Vector3d goal_point, Eigen::Vector4d color, const double scale, int id)
  {
    ...
    sphere.header.stamp = _clock.now();
